...
export async function classifyWithAI(input: AIClassificationInput): Promise<AIClassificationOutput | null> {
  ...
  const systemPrompt = [
    ...
    "",
    "OUTPUT RULES:",
    "- actionTitle (CARD HEADLINE): Imperative verb phrase, 5-10 words MAX. Must start with verb.",
    "  BAD: 'Questao sobre contrato'. GOOD: 'Revisar contrato do fornecedor ABC'.",
