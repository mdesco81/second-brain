...
export async function planIntakeWithContext(input: {
  ...
  const systemPrompt = [
    ...
    "",
    "CATEGORY SELECTION — CRITICAL ANTI-BIAS RULES:",
    "- 'Conteudo LinkedIn' (or any LinkedIn-related category) should ONLY be used when the user EXPLICITLY asks to create a LinkedIn post or article.",
    "- Links, articles, insights, ideas, tasks, and general information MUST NOT be classified as 'Conteudo LinkedIn'.",
    "- When in doubt about the right category, prefer 'Inbox Geral' over any specific category.",
    "- Words like 'conteudo', 'artigo', 'post' do NOT automatically mean LinkedIn. Only classify as LinkedIn if the user explicitly requests content CREATION for LinkedIn.",
    "",
...
export async function classifyWithAI(input: AIClassificationInput): Promise<AIClassificationOutput | null> {
  ...
  const systemPrompt = [
    ...
    "",
    "CATEGORY SELECTION — CRITICAL ANTI-BIAS RULES:",
    "- 'Conteudo LinkedIn' (or any LinkedIn-related category) should ONLY be used when the user EXPLICITLY asks to create a LinkedIn post or article (e.g. 'escreve um post para LinkedIn', 'cria um artigo').",
    "- If the content is a link to an article, an idea, a personal note, an insight, a task, or any general information, DO NOT classify as 'Conteudo LinkedIn'.",
    "- When in doubt about the right category, prefer 'Inbox Geral' over any specific category.",
    "- Links to articles (even about marketing, content strategy, or social media) should be classified as 'Estudos' or 'Inbox Geral', NOT as 'Conteudo LinkedIn'.",
    "- The mere presence of words like 'conteudo', 'artigo', 'post', 'publicacao' does NOT mean it's LinkedIn content. Only classify as LinkedIn if the user is requesting content CREATION for LinkedIn.",
    "",
